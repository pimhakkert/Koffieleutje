<nav class="topmenu">
    <div class="row">
        <div class="topmenu-logo col-3">
            <img src="{{ asset('imgs/logo_white.svg') }}" alt="Koffieleutje logo">
        </div>
        <div class="topmenu-navigation col-9">
            ...
            <a href="{{ route('coffeebox_index') }}" class="{{ request()->routeIs('coffeebox_index') ? 'active' : '' }}">
                <h2>Koffie box</h2>
                <span></span>
            </a>
        ...
        <div class="topmenu-mobile col-3">
            <img src="{{ asset('imgs/mobile_menu.svg') }}" alt="Mobile menu">
        </div>
    </div>
